...
public class Viaje {
    ...
    public void agregar() {
        ...
        String idRuta = ventanaViajes.Entrada_Ruta.getSelectedItem().toString();
        String precio = ventanaViajes.Entrada_Precio.getText();
        String conductor1 = ventanaViajes.Entrada_Primer_Conductor.getSelectedItem().toString();
        String conductor2 = ventanaViajes.Entrada_Segundo_Conductor.getSelectedItem().toString();
