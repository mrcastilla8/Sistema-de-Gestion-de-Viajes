...
public class ingresoDatosPersonales extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField5.setBackground(new java.awt.Color(132, 167, 161));
        jTextField5.setFont(new java.awt.Font("SF Pro Display", 0, 13)); // NOI18N
        ...
        jTextField6.setBackground(new java.awt.Color(132, 167, 161));
        jTextField6.setFont(new java.awt.Font("SF Pro Display", 0, 13)); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (!nombres.equals("") && !apellidos.equals("") && !dni.equals("") && !numAsiento.equals("") 
            && !edad.equals("") && !telefono.equals("") && index < asientosElegidos.size()) {
            modeloVB.actualizarAsiento(idViaje, numAsiento);
            modeloVB.imprimirBoleto(idViaje, numAsiento, nombres, apellidos, dni);
            modeloVB.agregarPasajero(idViaje, nombres, apellidos, dni, Integer.parseInt(edad), telefono);
            modeloVB.agregarBoleto(idViaje, dni, idOperador);
